...
namespace Bango::Colors
{
	...
	namespace Funcs
	{
		BANGOSCRIPTS_EDITORTOOLING_API FLinearColor BrightenColor(FLinearColor C);
		BANGOSCRIPTS_EDITORTOOLING_API FLinearColor EnhanceColor(FLinearColor C);
		BANGOSCRIPTS_EDITORTOOLING_API FLinearColor LightDesatColor(FLinearColor C);
		BANGOSCRIPTS_EDITORTOOLING_API FLinearColor DarkDesatColor(FLinearColor C);
		BANGOSCRIPTS_EDITORTOOLING_API FLinearColor VeryDarkDesatColor(FLinearColor C);
		BANGOSCRIPTS_EDITORTOOLING_API FLinearColor GetHashedColor(uint32 Hash, float Saturation, float Luminosity);
		BANGOSCRIPTS_EDITORTOOLING_API FLinearColor Desaturate(FLinearColor InColor, float Desaturation);
