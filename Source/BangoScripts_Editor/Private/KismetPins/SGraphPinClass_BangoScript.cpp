...
namespace GraphPinClass_BangoScript
{
...
TSharedRef<SWidget> SGraphPinClass_BangoScript::GenerateAssetPicker()
{
	...
	TSharedRef<GraphPinClass_BangoScript::FPropertyEditorClassFilter> PropEdClassFilter = MakeShared<GraphPinClass_BangoScript::FPropertyEditorClassFilter>();
