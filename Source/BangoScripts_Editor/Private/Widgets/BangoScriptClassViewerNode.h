...
class FBangoScriptClassViewerNode : public TSharedFromThis<FBangoScriptClassViewerNode>
{
public:
	FBangoScriptClassViewerNode(UClass* Class);
	 ...
	 */
	FBangoScriptClassViewerNode( const FString& InClassName, const FString& InClassDisplayName );

	FBangoScriptClassViewerNode( const FBangoScriptClassViewerNode& InCopyObject);
	 ...
	 */
	void AddChild( TSharedPtr<FBangoScriptClassViewerNode> Child );
	...
	TArray<TSharedPtr<FBangoScriptClassViewerNode>>& GetChildrenList()
	{
		return ChildrenList;
	}
	...
	TSharedPtr< FBangoScriptClassViewerNode > GetParentNode() const;
...
private:
	...
	/** List of children. */
	TArray<TSharedPtr<FBangoScriptClassViewerNode>> ChildrenList;

	/** Pointer to the parent to this object. */
	TWeakPtr< FBangoScriptClassViewerNode > ParentNode;
