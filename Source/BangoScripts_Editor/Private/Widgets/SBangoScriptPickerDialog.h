...
class SBangoScriptPickerDialog : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS( SBangoScriptPickerDialog )
		: _AssetType(NULL)
	{}
	...
	static bool PickClass(const FText& TitleText, const FClassViewerInitializationOptions& ClassViewerOptions, UClass*& OutChosenClass, UClass* AssetType);
...
private:
	...
	TSharedPtr<class SBangoScriptClassViewer> ClassViewer;
