...
TSharedRef<class FSlateStyleSet> FBangoEditorStyle::Create()
{
	...
	Style->SetContentRoot(IPluginManager::Get().FindPlugin("BangoScripts")->GetBaseDir() / TEXT("Resources"));
...
void FBangoEditorStyle::SetupStyles()
{
	...
	BANGO_DEFINE_BRUSH(FSlateVectorImageBrush,	Icon_StreamingSourceIndicator,		"NodeIcons/Icon_StreamingSourceIndicator", ".svg",		FVector2f(20, 20), Bango::Colors::White);
	...
	BANGO_DEFINE_BRUSH(FSlateVectorImageBrush,	Icon_ActorRefButton_StreamingSource,"ButtonIcons/Icon_ActorRefButton_StreamingSource", ".svg",	FVector2f(20, 20), Bango::Colors::White);
