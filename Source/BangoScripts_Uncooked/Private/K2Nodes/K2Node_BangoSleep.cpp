...
{
	/*
  	ExecutePin = CreatePin(EGPD_Input, UEdGraphSchema_K2::PC_Exec, UEdGraphSchema_K2::PN_Execute);
	CompletedPin = CreatePin(EGPD_Output, UEdGraphSchema_K2::PC_Exec, UEdGraphSchema_K2::PN_Completed);
	
	DurationPin = CreatePin(EGPD_Input, UEdGraphSchema_K2::PC_Real, K2Node_BangoSleepPins::Duration);
	DurationPin->AutogeneratedDefaultValue = FString::SanitizeFloat(Duration);

    SkipExecPin = CreatePin(EGPD_Input, UEdGraphSchema_K2::PC_Exec, K2Node_BangoSleepPins::SkipExec);
	...
	CancelExecPin = CreatePin(EGPD_Input, UEdGraphSchema_K2::PC_Exec, K2Node_BangoSleepPins::CancelExec);
    ...
    SkipConditionPin = CreatePin(EGPD_Input, UEdGraphSchema_K2::PC_Boolean, K2Node_BangoSleepPins::SkipCondition);
	...
	CancelConditionPin = CreatePin(EGPD_Input, UEdGraphSchema_K2::PC_Boolean, K2Node_BangoSleepPins::CancelCondition);
	...
	PauseConditionPin = CreatePin(EGPD_Input, UEdGraphSchema_K2::PC_Boolean, K2Node_BangoSleepPins::PauseCondition);
	...
	*/
	...
	if (bEnableSkipConditionPin)
	{
		...
		//SkipConditionPin->AutogeneratedDefaultValue = false;
		SkipConditionPin->PinFriendlyName = LOCTEXT("SleepNodeSkipConditionPinLabel", "Skip");
		SkipConditionPin->PinToolTip = "Polled on tick. If true, the sleep will complete.";
	}
	...
	if (bEnableCancelConditionPin)
	{
		...
		//CancelConditionPin->AutogeneratedDefaultValue = false;
		CancelConditionPin->PinFriendlyName = LOCTEXT("SleepNodeCancelConditionPinLabel", "Cancel");
		CancelConditionPin->PinToolTip = "Polled on tick. If true, the sleep will cancel. Output will NOT execute.";
	}

	if (bEnablePauseConditionPin)
	{
...
void UK2Node_BangoSleep::UpdatePinStates()
{
	/*
	DurationPin->bHidden = bInfiniteDuration;
	DurationPin->bNotConnectable = bInfiniteDuration;
	
	SkipExecPin->bHidden = !bEnableSkipExecPin;
	SkipExecPin->bNotConnectable = !bEnableSkipExecPin;
	
	CancelExecPin->bHidden = !bEnableCancelExecPin;
	CancelExecPin->bNotConnectable = !bEnableCancelExecPin;
	
	SkipConditionPin->bHidden = !bEnableSkipConditionPin;
	SkipConditionPin->bNotConnectable = !bEnableSkipConditionPin;
	
	CancelConditionPin->bHidden = !bEnableCancelConditionPin;
	CancelConditionPin->bNotConnectable = !bEnableCancelConditionPin;
	
	PauseConditionPin->bHidden = !bEnablePauseConditionPin;
	PauseConditionPin->bNotConnectable = !bEnablePauseConditionPin;
	*/
}
